        ...
        >
          ...
          >
            ...
            <motion.path
              ...
              fill="none"
              animate={{
                stroke: isHovered ? '#BEFE00' : '#333333',
                d: isHovered
            ...
            <motion.path
              ...
              fill="none"
              animate={{
                stroke: isHovered ? '#BEFE00' : '#444444',
            ...
            <motion.ellipse
              ...
              fill="none"
              animate={{
                stroke: isHovered ? 'rgba(190, 254, 0, 0.3)' : '#222222',
              }}
            />
            ...
            <motion.line
              ...
              strokeDasharray="2 2"
              animate={{
                stroke: isHovered ? 'rgba(190, 254, 0, 0.2)' : '#222222',
              }}
            />
            <motion.line
              x1="68"
            ...
            <motion.circle cx="8" cy="48" r="1" fill="#333333" animate={{ fill: isHovered ? '#BEFE00' : '#333333' }} />
            <motion.circle cx="72" cy="48" r="1" fill="#333333" animate={{ fill: isHovered ? '#BEFE00' : '#333333' }} />
            <motion.circle cx="40" cy="66" r="1" fill="#222222" animate={{ fill: isHovered ? 'rgba(190, 254, 0, 0.5)' : '#222222' }} />
          </svg>
